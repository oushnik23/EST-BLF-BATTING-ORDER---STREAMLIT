...
# Apply ranking for each year based on Sold_Qty >= 50000
for year in sold_qty.columns:
    valid_rows = sold_qty[year] >= 50000
...
excel_path = "CATP.xlsx"
filtered_df.to_excel(excel_path, index=True,sheet_name="CA TP")
