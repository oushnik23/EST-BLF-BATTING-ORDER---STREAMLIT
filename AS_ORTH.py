...
WHERE
 ...
 EstBlf IN ('EST','BLF') AND if(SaleNo>=1 AND SaleNo<=13,53+SaleNo,SaleNo) between 14 and 63
...
excel_path = "AS_ORTH.xlsx"
filtered_df.to_excel(excel_path, index=True,sheet_name="AS ORTH")
