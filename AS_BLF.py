...
WHERE
 Season IN (2025,2024) AND Area IN ("AS") AND Centre IN ("KOL","GUW") AND Category IN ('CTC') AND EstBlf IN ('BLF')
...
excel_path = "AS_BLF.xlsx"
filtered_df.to_excel(excel_path, index=True,sheet_name="AS BLF")
