...
# Apply ranking for each year based on Sold_Qty >= 25000
for year in sold_qty.columns:
    valid_rows = sold_qty[year] >= 25000
...
excel_path = "AS_ORTH_BLF.xlsx"
filtered_df.to_excel(excel_path, index=True,sheet_name="AS ORTH BLF")
